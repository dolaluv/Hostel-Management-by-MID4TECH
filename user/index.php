...
$sql=mysqli_query($conn,"select * from student where matric_no='$user' ");
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#"> <?php echo  $users['matric_no']; ?></a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			...
			<?php 
			$q=mysqli_query($conn,"select image from student where matric_no='".$_SESSION['user']."'");
        ...
        <li><a href="index.php?page=complain"><span class="glyphicon glyphicon-envelope"></span> Complains</a></li>
         <li><a href="index.php?page=visit_student"><span class="glyphicon glyphicon-envelope"></span> Visitors</a></li>
